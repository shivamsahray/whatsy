...
const ChatList = () => {
    ...
    const filteredChats = chats?.filter((chat) => chat.groupName?.toLowerCase()
    ...
    useEffect(() => {
        ...
        const handleChatUpdate = (data : {
            ...
            console.log("Recieved updated chat", data.lastMessage);
    ...
    return <div className="fixed inset-y-0 *:
        pb-20 lg:pb-0 lg:max-w-[379px] lg:block border-r border-border bg-sidebar max-w-[calc(100% - 40px)] w-full left-10 z-98
    ">
