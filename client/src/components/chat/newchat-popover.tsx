    ...
    return <Popover open={isOpen} onOpenChange={handleOpenChange}>
        ...
        <PopoverContent align="start"
            className="w-80 z-999 p-0 rounded-xl min-h-[400px] max-h-[80vh] flex flex-col">
                ...
                <div className="flex-1 justify-center px-1 py-1 space-y-1 overflow-auto">
                    {isUsersLoading ? (
...
const ChatUserItem = memo(
    ({
        ...
        return <button className="relative w-full flex items-center gap-2 p-2 rounded-sm hover:bg-accent transition-colors disabled:opacity-50"
