...
export const ChatBodyMessage = memo(({
    ...
    const contentWrapperClass = cn(
        "max-w-[70%] flex flex-col relative", isCurrentUser && "items-end"
    )
        ...
        <div className={containerClass}>
            ...
            <div className={contentWrapperClass}>
                <div className={cn("flex items-center gap-1",
                    ...
                    {/* ReplyIconButton */}
                    <Button variant="outline" size="icon" onClick={() => onReply?.(message)}
                        className="flex opacity-0 group-hover:opacity-100 transition-opacity rounded-full !size-8">
                        <ReplyIcon size={16} className={cn("text-gray-500 dark:text-white !stroke-[1.9]", 
